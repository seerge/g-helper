...
# [:floppy_disk:Download](https://github.com/seerge/g-helper/releases/download/v0.148/GHelper.zip) 
...
- [AsusCtrl](https://gitlab.com/asus-linux/asusctl) for inspiration and some reverse engineering
