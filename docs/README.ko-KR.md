...
<a href="https://github.com/seerge/g-helper/releases/latest/download/GHelper.exe" alt="G-Helper - Asus 노트북용 경량 제어 도구"><img width="1280" alt="G-Helper - Asus 노트북용 경량 제어 도구" src="https://g-helper.com/hero/ko.png" /></a>
...
### :keyboard: Asus 키보드 지원

<details>
<summary><a href="https://github.com/seerge/g-helper/discussions/5710">현재 지원되는 모델</a> (클릭하여 펼치기)</summary>
...
### :headphones: Asus 헤드셋 지원

<details>
<summary><a href="https://github.com/seerge/g-helper/discussions/5964">현재 지원되는 모델</a> (클릭하여 펼치기)</summary>
...
배터리 잔량, 조명, 이퀄라이저 프리셋, 사이드톤, 마이크 AI 노이즈 캔슬링, ANC, 전원 설정을 모델에 따라 지원합니다.
...
> [!NOTE]
> ### 🔖 중요 안내
> G-Helper는 운영 체제, 펌웨어, 드라이버가 **아닙니다**. 어떤 식으로든 하드웨어를 실시간으로 「구동」하지 **않습니다**.
> 
...
> 
> 노트북에서 G-Helper의 역할은 TV의 리모컨과 비슷합니다.
